#----------------------------------------------------------------
# calculate network distance with 2000 shuffled data points 
...
for k in range(1,101,1):
    sectab=pd.read_csv(dir1+name1+'_mw_less_shuffle_'+str(k)+'.csv')
    ...
    # save data
    with open(dir2+name1+"_networkdistance_motorway_shuffle_"+str(k)+".csv", "w", newline="") as f:
