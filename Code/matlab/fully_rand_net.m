%--------------------------------------------------------------------------
% construct fully random network with random nodes and random connections
...
% 2. Connect two nodes by an edge with probability p.
...
% an example of network with 20 locations
...
for ip=1:length(pp)
    ...
    title(['f=',num2str(p),',  l_{',num2str(s),',',num2str(t),'}=',...
...
xl=[900 700 700 700 700 700];
yl=[0.0045 0.0045 0.0045 0.0045 0.0045 0.0045];
figure(1)
